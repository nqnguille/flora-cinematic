...
// Mail del débito — paleta clara de marca (violeta + verde bosque sobre
...
<body style="margin:0;padding:0;background:#f4f1f7;">
  ...
  try {
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({ from: 'Flora <hola@floraong.ar>', to: d.email, subject: 'Un 20% que llega justo a tiempo ⏰🌿', html }),
    });
