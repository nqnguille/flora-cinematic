...
export const extracciones = [
  {
    ...
    detalle: 'THC',
    desc: 'Extracto de THC en cartucho 510 de 1 ml. Uso discreto y dosificado, para vapear con batería 510.',
  ...
  },
  {
    ...
    detalle: 'THC',
    desc: 'La misma extracción de THC en formato 0,5 ml, ideal para empezar o llevar encima.',
  ...
  },
  {
    ...
    nombre: 'Cartucho 0,5 ml',
    detalle: 'CBD',
    desc: 'Extracto de CBD en cartucho 510 de 0,5 ml. Calma sin efecto psicoactivo, para el día.',
  ...
  },
  {
    ...
    desc: 'Batería universal rosca 510, recargable por USB. Compatible con todos nuestros cartuchos.',
